...
public class pruebasAsciimation{
    ...
    public static void main(String[] args){
        ...
        box = AsciiBox.asciiBox(intro, -1, true, true);        
        try{
            AsciiBox.wait(10000);
        } catch(InterruptedException e){}
        //Leemos un Ascii Art de un archivo en una lista.
        ArrayList<String> asciiList = AsciiBox.readAsciiFile("asciimation.txt");
        //Imprimimos animación Ascii (ascimation)
        AsciiBox.asciiMation(asciiList, 30);
        //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        //Creamos una caja y la animamos
        box = AsciiBox.asciiBox(anillo, -1, true, false);
        AsciiBox.asciimateBox(box, 5);
    }
}